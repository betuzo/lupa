...
@Configuration
@EnableJpaRepositories(basePackages = {"com.codigoartesanal.lupa.repositories"})
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
        ...
        lef.setPackagesToScan("com.codigoartesanal.lupa.model");
        return lef;
    }
    ...
    public DataSourceInitializer dataSourceInitializerConfigurationDev() {
        ...
        resourceDatabasePopulator.addScript(new ClassPathResource("/com/codigoartesanal/lupa/scripts/h2/ddl/egresototales.sql"));
    ...
    public DataSourceInitializer dataSourceInitializerConfiguration() {
        ResourceDatabasePopulator resourceDatabasePopulator = new ResourceDatabasePopulator();
        resourceDatabasePopulator.addScript(new ClassPathResource("/com/codigoartesanal/lupa/scripts/postgresql/user.sql"));
