    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE, "/ingresotoken/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/egresotoken/**").permitAll()
                .antMatchers(HttpMethod.GET, "/**").permitAll()
                .antMatchers(HttpMethod.POST, "/**").hasRole("RECAUDADOR")
                .antMatchers(HttpMethod.PUT, "/**").hasRole("RECAUDADOR")
                .antMatchers(HttpMethod.DELETE, "/**").hasRole("RECAUDADOR")
                .and()
            .csrf()
                .disable()
            .sessionManagement()
