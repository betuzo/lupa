define([
    ...
    var pleaseWaitDiv = $('<div class="modal fade" data-keyboard="false" tabindex="-1"><div class="modal-base"><img src="img/loadlupa.gif" style="display: block; margin: auto;"/></div></div>');
    var callServers = 0;
